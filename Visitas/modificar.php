                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="time" required="required" value='<?php echo $mostrar['hor_visita']; ?>'  class="form-control" id="hor_visita" name="hor_visita">
                                            </div>
                                            <div class="col-md-2">
...
<!--                                                <label type="button" class="btn btn-danger">
                                            ...
                                            <div class="col-md-3">
                                                <label><strong class="text-danger" style="font-size: 20px">*</strong> Credencial </label>
