<div class="form-group">
    ...
    <input type="text" class="form-control" name="nombre" required="required" placeholder="ejemplo: Luis Medina">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="password" class="form-control" name="clave1" placeholder="minimo 8 caracteres">
</div>
<div class="form-group">
